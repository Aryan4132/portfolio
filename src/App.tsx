    ...
    <div className="relative min-h-screen bg-[#030712] text-slate-100 overflow-x-hidden selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-2">
        <button
          ...
          className="p-3.5 rounded-2xl bg-gradient-to-r from-cyan-500 to-indigo-600 text-white shadow-2xl hover:scale-110 transition-all flex items-center justify-center border border-cyan-400/30"
